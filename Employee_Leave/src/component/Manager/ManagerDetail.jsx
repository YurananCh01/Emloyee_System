...
const ManagerDetail = () => {
    ...
    useEffect(() => {
        ...
        const fetchManagerDetails = async () => {
            try {
                const response = await axios.get(`http://172.16.252.120:3000/manager/manager_detail/${id}`);
        ...
        const fetchLeaveRequests = async () => {
            try {
                const response = await axios.get('http://172.16.252.120:3000/leave/leaves');
        ...
        const fetchEmployees = async () => {
            try {
                const response = await axios.get('http://172.16.252.120:3000/auth/employee');
                if (response.data.Status) {
    ...
    const handleApprove = (leave) => {
        axios.put('http://172.16.252.120:3000/manager/approve_leave', {
            leave_id: leave.id,
    ...
    const handleReject = (leave_id) => {
        axios.put('http://172.16.252.120:3000/manager/reject_leave', { leave_id })
            .then(result => {
                if (result.data.Status) {
